...
//           {total_min === total_max
//             ? total_max
//             : `${total_min} to ₹ ${total_max}`}
//         </Type>
//         <Divider />
//         <Type style={{ fontSize: 13 }}>
//           Pro Tip: Do confirm the refund amount with the dealer on call too,
//           there's a lot of fluidity in their pricing plans. Might save up on
//           some more!
//         </Type>
//         <div className="logo">
//           <div
...
//             </button>
//             <button
//               style={{ background: COLOURS.GREEN1, color: "white" }}
//               onClick={() => hide(false)}
//             >
//               CONTINUE
//             </button>
