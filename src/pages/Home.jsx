...
import { CardStack, Subheading, FormStyles } from "../styles/components/HomeStyles";
		...
		<>
			...
			<Flex center column m='5rem 0 4rem 0'>
				<Subheading>
					...
					<Type>
						MUJ HUB is an application that caters to the day-to-day needs of any student in our university, from displaying the mess menu to ordering
						food from outlets. The app developed by fellow students aims at making your life at MUJ easier.
					</Type>
					<H6 className='services'>Services We Offer</H6>
					<Type>
						Our array of features will be accessible via the native applications coming to <br />
			...
			<Flex column center>
				<Subheading>
					...
					<Type>
						We promise to hear you out and help you in whatever way we can. <br />
						Found something cool and wish it existed on MUJ HUB? Put it in the form below!
					</Type>
				</Subheading>
				...
				<FormStyles>
					<form name='Feedback' method='post' data-netlify='true' data-netlify-honeypot='bot-field'>
						...
						<div>
							...
							<textarea rows='5' cols='40' wrap='hard' type='text' name='message' id='message' placeholder='Message' />
						</div>
